...
StairBlock*(*StairBlock$StairBlock)(StairBlock*, std::string const&, int, Block&, int);
...
static void Block$initBlocks() {
	...
	myBlockPtr = new StairBlock();
	//Block$Block(myBlockPtr, "testblock", testItem, Material$getMaterial(MaterialType::DEFAULT));
	StairBlock$StairBlock(myBlockPtr, "testblock", testItem, *Block$mBlocks[1], 0);
...
static void BlockGraphics$initBlocks() {
	...
	myBlockGraphicsPtr->blockShape = 10;
...
%ctor {
	...
	StairBlock$StairBlock = (StairBlock*(*)(StairBlock*, std::string const&, int, Block&, int))(0x100821e5c + _dyld_get_image_vmaddr_slide(0));
